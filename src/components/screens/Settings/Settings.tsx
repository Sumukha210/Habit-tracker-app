      ...
      <ScrollView className="flex-1 p-4">
        ...
        >
          <View className="flex-row items-center">
            <Ionicons name="color-palette-outline" size={24} color={isDarkMode ? '#E1E1E1' : '#202124'} className="mr-3" />
            <Text className={`${isDarkMode ? 'text-text-primary-dark' : 'text-text-primary'}`}>Appearance</Text>
          </View>
          <Ionicons name="chevron-forward" size={20} color={isDarkMode ? '#A1A1A1' : '#5F6368'} />
        </TouchableOpacity>
      </ScrollView>
    </ScreenWrapper>
  );
